...
$config['twiggy']['environment']['auto_reload']        	= TRUE;
...
(
	'base_url', 'link_base', 'lang', 'include_path', 'current_url', 'static_url', 
	'uri_string', 'isset', 'count', 'post_ride_link', 'my_profile_link', 'events_link', 
	'invite_link', 'img', 'script', 'css', 'my_rides_link', 'my_messages_link', 
	'logout_link', 'signup_link', 'login_link', 'search_link', 'static_link', 
	'telefono_empresa', 'pro_link', 'ride_link', 'puntual_to_string', 'periodico_to_html', 
	'price_to_string', 'crop_text', 'event_link', 'user_profile_link', 'periodico_to_string', 
	'substr', 'strpos', 'get_dias', 'stripos', 'hora_to_string', 'limitarCadena', 
	'mktime', 'in_array', 'explode', 'matricula_to_string', 'localize_distancia', 
	'localize_co2', 'conversation_link', 'ucwords', 'strtolower', 'href', 'strlen', 
	'email_incidencias', 'str_replace', 'date_format_by_region', 'premios_bases_link', 
	'in_string', 'filter_var', 'confirm_email_link', 'in_array', 'email_contacto', 
	'ajax_link', 'reset_password_link', 'confirm_network_link', 'round', 'user_pic_url', 
	'array_unshift', 'user_pic', 'network_link', 'user_comments_link'
);
...
(
	'htmlspecialchars', 'rfc_date', 'crop_text', 'strtolower', 'dm_value', 'strong', 
	'strip_accents', 'span', 'datetime_to_date'
);
